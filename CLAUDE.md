...
**Stale, pending rewrite: broker-framing copy.** PRODUCT.md's Product Purpose/Positioning were revised 2026-09 to drop broker/marketplace framing for a direct-brand presentation (see PRODUCT.md for why). The live homepage copy still uses the old framing in three places and has not been rewritten yet: the hero lead paragraph ("Astery Group не производит мебель сама — мы подбираем..."), the "Мы не мастерская — мы её выбор" why-us section (title + all 4 items, especially "Сравниваем несколько вариантов"), and the FAQ answer to "Вы сами производите мебель?" ("Нет, у нас нет собственного цеха..."). Rewrite these to the direct-brand framing — keeping the no-fabricated-facts boundary from PRODUCT.md intact — next time homepage copy is touched.
